<!doctype html>
	...
	<head>
		...
		<link rel="stylesheet" title="style" href="./../assets/dest/css/font-awesome.min.css">
	...
	<body>
		...
		<div class="rev-slider">
										...
										<div class="col-sm-3">
											<div class="single-item">
												<div class="single-item-header">
													<a href="product.html"><img src="/assets/image/product/{{ ($products -> image) }}" alt="" style="height: 320px;"></a>
												</div>
												...
												<div class="single-item-caption">
													...
													<a class="beta-btn primary" href="{{route('products.detail', $products->id)}}">Details <i class="fa fa-chevron-right"></i></a>
													<div class="clearfix"></div>
												</div>
											</div>
										</div>
			...
			<script src="./../assets/dest/query.js"></script>
