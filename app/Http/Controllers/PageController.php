...
public function postCheckout(Request $req){
    ...
    if($req->payment_method==='vnpay')
    {
        ...
        $vnp_TmnCode = "I0PIRGEJ"; //Mã website tại VNPAY 
        $vnp_HashSecret = "SZISSIJZURJBLTDQEFODRZIAJLABPICQ"; //Chuỗi bí mật
        $vnp_Url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
        $vnp_Returnurl = "http://myappofhoa.com/returnVNpay";
...
// Trang chủ
    ...
    public function getOrderPayment(Request $request){
        ...
        $bill=Payment::all();
        return view('admin.payment_data', compact('bill'));
    }
